        ...
        <div className="container mx-auto p-8">
            ...
            <section className="mb-12">
                ...
                <div className="space-y-4">
                    <div className="flex flex-wrap gap-4">
                        <Button text="Primary" intent="primary" onClick={() => console.log("Primary clicked")} />
                        <Button text="Secondary" intent="secondary" onClick={() => console.log("Secondary clicked")} />
                        <Button text="Danger" intent="danger" onClick={() => console.log("Danger clicked")} />
                    </div>

                    <div className="flex flex-wrap gap-4">
                        <Button text="Small" size="sm" onClick={() => console.log("Small clicked")} />
                        <Button text="Medium" onClick={() => console.log("Medium clicked")} />
                        <Button text="Large" size="lg" onClick={() => console.log("Large clicked")} />
                    </div>
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        />
                        <Button text="Cargando" isLoading={true} onClick={() => console.log("This won't log")} />
                    </div>
